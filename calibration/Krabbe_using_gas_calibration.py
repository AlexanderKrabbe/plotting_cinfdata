...
x, y_CO2 = CO2.get_flux(data, tspan=[2000, 63800])

x_CO, y_CO = CO.get_flux(data, tspan=[2000, 63800])

x_Ar, y_Ar = Ar.get_flux(data, tspan=[2000, 63800])

x_O2, y_O2 = O2.get_flux(data, tspan=[2000, 63800])
...
fig, ax = plt.subplots()
ax.plot(x, p_CO2, color=CO2.get_color(), label='CO2')
ax.plot(x, p_CO, color=CO.get_color(), label='CO')
ax.plot(x, p_O2, color=O2.get_color(), label='O2')
ax.plot(x, p_Ar, color=Ar.get_color(), label='Ar')
ax.legend()
plt.show()
